...
const Mascot: React.FC<MascotProps> = ({className, fromP, type,  ...rest}) => {
    ...
    return (
        ...
        {mascotAccessory.map((item: string) => {
            ...
            if (item === 'AS_babyCollar' || item === 'AS_fullset' || item === 'AS_ribbonCollar') {
                ...
                return <Image source={imageSource} className="w-full h-full object-contain rounded-md absolute"/>
            }
            }
        )}
        ...
        {/* <Image source={EF_hearts} className="w-full h-full object-contain rounded-md absolute"/> */}


        {/* <Image source={M_bigHeart} className="w-full h-full object-contain rounded-md absolute"/> */}
        {/* <Image source={M_coin} className="w-full h-full object-contain rounded-md absolute"/> */}
